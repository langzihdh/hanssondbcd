...
import com.hansson.dybalcalc.event.HanssonEvent.PostViewChangeEvent;
...
public class HanssonNavigator extends Navigator {

    // Provide a Google Analytics tracker id here
    private static final String TRACKER_ID = null;// "UA-658457-6";
    private GoogleAnalyticsTracker tracker;

    private static final HanssonViewType ERROR_VIEW = HanssonViewType.TOOLS;
    private ViewProvider errorViewProvider;

    public HanssonNavigator(final ComponentContainer container) {
    ...
    private void initViewChangeListener() {
        addViewChangeListener(new ViewChangeListener() {
            ...
            public void afterViewChange(final ViewChangeEvent event) {
                HanssonViewType view = HanssonViewType.getByViewName(event
                        .getViewName());
                // Appropriate events get fired after the view is changed.
                HanssonEventBus.post(new PostViewChangeEvent(view));
    ...
    private void initViewProviders() {
        ...
        for (final HanssonViewType viewType : HanssonViewType.values()) {
